...
Imported from [obra/superpowers](https://github.com/obra/superpowers/blob/HEAD/skills/diagnosing-superpowers/SKILL.md) — Use when a superpowers session went wrong and your human partner wants to know why — repeated work, ignored plans, stumbles, poor results, a skill that didn't fire, "it took too long", "why is it so e.
